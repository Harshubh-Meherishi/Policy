...
const NFTCard = (props: NFTCardProps) => {
  ...
  const onBuyClicked = async () => {
    ...
    try {
      ...
      router.push("/owned");
      toast.success(
        "You Policies will be updated shortly! Refresh the page."
      );
    } catch (e) {
      showErrorToast();
      console.log(e);
  ...
  const onCancelClicked = async () => {
    ...
    try {
      ...
      toast.success(
        "You canceled this policy listing. Changes will be reflected shortly."
      );
    } catch (e) {
      showErrorToast();
      console.log(e);
  ...
  const onSellConfirmed = async (price: BigNumber) => {
    ...
    try {
      ...
      toast.success(
        "You listed this Policy for sale. Changes will be reflected shortly."
      );
    } catch (e) {
      showErrorToast();
      console.log(e);
